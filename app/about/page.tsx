      ...
      <div className="container px-4 lg:px-12 mx-auto">
        ...
        <div className="lg:flex space-x-2 justify-between">
          <div className="lg:w-6/12 relative z-10">
            ...
            <p className="text-gray-100 font-sans text-md mb-10 lg:max-w-2xl">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maxime
              quia tempora sunt ipsum itaque. Amet ratione consectetur repellat,
              accusantium autem quas nam commodi est cum. Corrupti porro quae
              iste nemo veritatis odio autem nihil repudiandae, reiciendis qui
              sequi aperiam asperiores praesentium exercitationem! Ab tempora
              nesciunt quas, illo, ducimus molestias aliquid, atque explicabo
              voluptate fugiat earum blanditiis veniam? Dolor sed enim
              molestiae, molestias corrupti repellendus laudantium culpa
              inventore recusandae suscipit quisquam.
            </p>
          </div>
          <div className="lg:w-6/12 relative z-10">
            <h2 className="text-sky-200 font-sans text-xl lg:text-2xl font-bold mb-5 border-b-sky-200">
