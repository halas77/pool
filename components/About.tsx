...
const About = () => {
  return (
    <section className="py-8 lg:py-10 md:px-10 max-sm:py-10 bg-[#243238]">
      <div className="conatiner px-4 mx-auto">
        <div className="lg:flex justify-center items-center">
          ...
          <div className="lg:w-5/12 mb-10 lg:mb-0 p-10">
            ...
            <p className="leading-relaxed text-gray-200 text-[18px]  mb-10">
